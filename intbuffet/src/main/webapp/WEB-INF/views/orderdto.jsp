...
<body>
	...
	<section id="cart_items">
		<div class="container">
			<form:form action="makeCopyOrder" modelAttribute="order"
				...
				<table>
					...
					<tr>
						...
						<td><form:select path="paymentmethod">
								<form:options items="${paymentmethod}" itemValue="name"
									itemLabel="name" />
							</form:select></td>
					</tr>
					<tr>
				...
				<div class="table-responsive cart_info">
					<table class="table table-condensed">
						...
						<tbody>
              <form:hidden path="ordersProductsDTO" value ="${ordersProductsDTO}"></form:hidden>
										
							<c:if test="${not empty order.ordersProductsDTO}">

								<c:forEach var="item" items="${order.ordersProductsDTO}">
								...
								<tr>
									<td colspan="3" style="text-align: right" class="cart_total">
										<form:label path="ordertotal" value ="${order.ordertotal}"><p class="cart_total_price" id="totalItem">Total
											price: ${order.ordertotal} &#8364;</p></form:label>
									</td>
								</tr>
							</c:if>
